...
mpc.bus = [  %% (Pd and Qd are specified in kW & kVAr here, converted to MW & MVAr below)
	...
	16	1	60	20	0	0	1	1	0	12.66	1	1.01	0.99;
	...
	22	1	90	40	0	0	1	1	0	12.66	1	1.01	0.99;
	...
	30	1	200	600	0	0	1	1	0	12.66	1	1.01	0.99;
...
mpc.branch = [  %% (r and x specified in ohms here, converted to p.u. below)
	...
	12	13	1.4680	1.1550	0	0	0	0	0	0	0	-360	360;
	...
	24	25	0.8960	0.7011	0	0	0	0	0	0	0	-360	360;
	...
	8	21	2.0000	2.0000	0	0	0	0	0	0	0	-360	360;
...
mpc.gen(:,[2,3,4,5]) =mpc.gen(:,[2,3,4,5])/1e3;
